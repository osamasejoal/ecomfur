            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-11 m-auto">
                        ...
                        <div class="add-supporter mb-3 float-end">
                            <a href="{{ route('supporter.create') }}" class="btn btn-warning btn-md"> + Add Supporter </a>
                        </div>
                        ...
                        <table class="table table-nowrap text-center table-light table-bordered">
                            <thead>
                                <tr class="table-bordered border-warning fw-bold">
                                    ...
                                    <th class="fw-bolder" scope="col">Url</th>
                            ...
                            <tbody>
                                @forelse ($supporters as $supporter)
                                    <tr>
                                        <!-- Name -->
                                        <td style="vertical-align:middle">{{ $supporter->name }}</td>

                                        <!-- Url -->
                                        <td style="vertical-align:middle">{{ $supporter->url }}</td>
                                        
                                        <!-- Logo -->
                                        <td style="vertical-align:middle">
                                            @if ($supporter->logo)
                                            <img style="object-fit:cover;object-position:center;width:70px;height:70px;border-radius:10%"
                                            src="{{ asset($supporter->logo) }}" alt="" class="rounded-circle">
                                            @else
