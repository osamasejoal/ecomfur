                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="single-slider swiper-slide animation-style-01">
                            ...
                            <div class="slider-content">
                                ...
                                <a href="product-details.html" class="btn btn-primary btn-hover-dark btn-margin">purchase
                                    now</a>
                            </div>
                            <!-- Slider Content End -->
                            ...
                            <div class="slider-images">
                                <img src="{{ asset('frontend/assets') }}/images/slider/slider-item-1.png" width="707"
                                    height="477" alt="Slider" />
                            </div>
                            <!-- Slider images End -->
                        </div>
                        <!-- Single Slider End  -->
                        ...
                        <div class="single-slider swiper-slide animation-style-01">
                            ...
                            <!-- Slider images Start -->
                            <div class="slider-images">
                                <img src="{{ asset('frontend/assets') }}/images/slider/slider-item-2.png" width="707"
                                    height="477" alt="Slider" />
                            </div>
                            <!-- Slider images End -->
                        </div>
                        ...
                        <div class="single-slider swiper-slide animation-style-01">
                            ...
                            <!-- Slider images Start -->
                            <div class="slider-images">
                                <img src="{{ asset('frontend/assets') }}/images/slider/slider-item-3.png" width="707"
                                    height="477" alt="Slider" />
                            </div>
                            <!-- Slider images End -->
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-banner">
                            <img src="{{ asset('frontend/assets') }}/images/banner/banner-01.jpg" width="370"
                                height="245" alt="Banner" />
                    ...
                    <div class="col-lg-4 col-md-6">
                        <!-- Single Banner Start -->
                        <div class="single-banner">
                            <img src="{{ asset('frontend/assets') }}/images/banner/banner-02.jpg" width="370"
                                height="245" alt="Banner" />
                    ...
                    <div class="col-lg-4 col-md-6">
                        <!-- Single Banner Start -->
                        <div class="single-banner">
                            <img src="{{ asset('frontend/assets') }}/images/banner/banner-03.jpg" width="370"
                                height="245" alt="Banner" />
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-banner-02">
                            <img src="{{ asset('frontend/assets') }}/images/banner/banner-04.jpg" width="270"
                                height="429" alt="Banner" />
            ...
            <div class="product-section-wrapper">
                <div class="row flex-row-reverse justify-content-center">
                    <div class="col-lg-3 col-md-6">
                        <!-- Single Banner Start -->
                        <div class="single-banner-02">
                            <img src="{{ asset('frontend/assets') }}/images/banner/banner-04.jpg" width="429"
                                height="303" alt="Banner" />
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-benefit">
                            <img src="{{ asset('frontend/assets') }}/images/icon/icon-1.png" width="70"
                                height="92" alt="Icon" />
                    ...
                    <div class="col-lg-4 col-md-6">
                        <!-- Single Benefit Start -->
                        <div class="single-benefit">
                            <img src="{{ asset('frontend/assets') }}/images/icon/icon-2.png" width="70"
                                height="92" alt="Icon" />
                    ...
                    <div class="col-lg-4 col-md-6">
                        <!-- Single Benefit Start -->
                        <div class="single-benefit">
                            <img src="{{ asset('frontend/assets') }}/images/icon/icon-3.png" width="70"
                                height="92" alt="Icon" />
