                    ...
                    <div class="single-slider slider-02 swiper-slide animation-style-01" style="
                        ...
                        <div class="container">
                            ...
                            <div class="slider-content-02 text-center">
                                ...
                                <a href="shop-grid-4-column.html" class="btn btn-primary btn-hover-dark btn-margin">purchase now</a>
                            </div>
                            <!-- Slider Content End -->
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-benefit">
                            <img src="{{ asset('frontend') }}/assets/images/icon/icon-1.png" width="70" height="92" alt="Icon" />
                        ...
                        <div class="tab-pane fade show active" id="tab1">
                            <div class="row">
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-01.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-02.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-03.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-04.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-05.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-06.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-11.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-08.jpg" width="270" height="303" alt="product" /></a>
                        ...
                        <div class="tab-pane fade" id="tab2">
                            <div class="row">
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-09.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-10.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-12.jpg" width="270" height="303" alt="product" /></a>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-product-02">
                                        <div class="product-images">
                                            <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/product/product-07.jpg" width="270" height="303" alt="product" /></a>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="single-banner-03">
                        <img src="{{ asset('frontend') }}/assets/images/banner/banner-05.jpg" width="570" height="299" alt="Banner" />
                ...
                <div class="col-lg-6">
                    <!-- Single Banner Start -->
                    <div class="single-banner-03">
                        <img src="{{ asset('frontend') }}/assets/images/banner/banner-06.jpg" width="570" height="299" alt="Banner" />
                ...
                <div class="row align-items-center">
                            ...
                            <div class="countdown-wrapper">
                                <div class="countdown" data-countdown="2024/11/20" data-format="short">
                                    <div class="single-countdown">
                                        <span
                                                class="count countdown__time daysLeft"
                                            ></span>
                                        <span
                                                class="value countdown__time daysText"
                                            ></span>
                                    </div>
                                    <div class="single-countdown">
                                        <span
                                                class="count countdown__time hoursLeft"
                                            ></span>
                                        <span
                                                class="value countdown__time hoursText"
                                            ></span>
                                    </div>
                                    <div class="single-countdown">
                                        <span
                                                class="count countdown__time minsLeft"
                                            ></span>
                                        <span
                                                class="value countdown__time minsText"
                                            ></span>
                                    </div>
                                    <div class="single-countdown">
                                        <span
                                                class="count countdown__time secsLeft"
                                            ></span>
                                        <span
                                                class="value countdown__time secsText"
                                            ></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="countdown-images">
                            ...
                            <div class="image-box">
                                <img src="{{ asset('frontend') }}/assets/images/countdown.png" width="480" height="383" alt="Countdown" />
                            </div>
                        </div>
