                    ...
                    <div class="footer-contact-payment">
                        <div class="footer-contact">
                            <div class="contact-icon">
                                <img src="{{ asset('frontend/assets') }}/images/icon/icon-4.png" width="39"
                                    height="46" alt="Icon" />
                            </div>
                        ...
                        <div class="footer-payment">
                            <img src="{{ asset('frontend/assets') }}/images/payment.png" width="192" height="21"
                                alt="Payment" />
                        </div>
                    </div>
                    <!-- Footer Contact & Payment End -->
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="single-img">
                                                <img src="{{ asset('frontend/assets') }}/images/product-details/product-details-1.jpg"
                                                    alt="Product Image" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-img">
                                                <img src="{{ asset('frontend/assets') }}/images/product-details/product-details-2.jpg"
                                                    alt="Product Image" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-img">
                                                <img src="{{ asset('frontend/assets') }}/images/product-details/product-details-3.jpg"
                                                    alt="Product Image" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-img">
                                                <img src="{{ asset('frontend/assets') }}/images/product-details/product-details-4.jpg"
                                                    alt="Product Image" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-img">
                                                <img src="{{ asset('frontend/assets') }}/images/product-details/product-details-5.jpg"
                                                    alt="Product Image" />
                                            </div>
                                        </div>
                                    </div>
