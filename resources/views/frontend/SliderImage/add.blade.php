                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Create Slider Image</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('SliderImage.view') }}">Slider Image</a></li>
                ...
                <div class="row">
                    <div class="col-lg-11 m-auto">
                        ...
                        <form action="{{ route('SliderImage.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="title" value="{{ old('title') }}" id="title"
                                        class="form-control" placeholder="Slider Image's Title">
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-2">
                                    <label for="slogan" class="form-label">Slogan: <span
                                            class="text-danger">*</span></label>
                                </div>
                                <div class="col-lg-10">
                                    <input type="text" name="slogan" value="{{ old('slogan') }}" id="slogan"
                                        class="form-control" placeholder="Slider Image's Slogan">
